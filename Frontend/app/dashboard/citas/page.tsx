...
export default function CitasPage() {
  ...
  const [citas, setCitas] = useState<Cita[]>([
    {
      ...
      estado: "pendiente",
      auto_id: "",
      cliente_id: "1", // Linked to Juan Pérez
    },
    {
      id: "2",
      ...
      estado: "en_progreso",
      auto_id: "",
      cliente_id: "2", // Linked to María García
    },
    {
      id: "3",
      ...
      estado: "completada",
      auto_id: "",
      cliente_id: "3", // Linked to Carlos López
    },
  ])
  ...
  const handleEdit = (cita: Cita) => {
    ...
    setFormData({
      ...
      cliente_id: cita.cliente_id, // Include cliente_id in form data
    })
